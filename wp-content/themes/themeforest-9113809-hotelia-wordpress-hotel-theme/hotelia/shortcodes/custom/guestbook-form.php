...
class WPBakeryShortCode_guestbook_form extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        $container = '<form action="#" id="guestbook-form" method="post" class="row no-padding %s">%s</form>';

        $room_search = locate_template( 'guestbook-form.php' );
